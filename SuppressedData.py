...
arcpy.MakeFeatureLayer_management("G:/Features.gdb/SoutheasternStates", "Suppressed_lyr")
#select by attribute
arcpy.SelectLayerByAttribute_management(lyr, "NEW_SELECTION", "\"Deaths\" = \'Supressed\'")
#selection is made, time to copy to new layer from selection
arcpy.CopyFeatures_management("Suppressed_lyr", "Features.gdb/Deaths")
